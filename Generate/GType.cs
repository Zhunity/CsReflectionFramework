    ...
    public class GType
    {
        ...
        public GType(Type type)
        {
			...
			foreach (var @event in events)
			{
				...
				{
					ReflectionUtils.Log(type.Name + "添加events失败:" + name + "  " + this.events[name] + " " + this.members[name]);
				}
			}
			...
			foreach (var field in fields)
			{
				...
				{
					ReflectionUtils.Log(type.Name + "添加field失败:" + name);
				}
			}
			...
			foreach (var property in properties)
			{
				...
				{
					ReflectionUtils.Log(type.Name + "添加properties失败:" + name);
				}
			}

			// 判断new op_Explicit_Decimal
			...
			foreach (var method in methods)
			{
				...
				{
					ReflectionUtils.Log(type.Name + "添加methods失败:" + name);
				}
			}
